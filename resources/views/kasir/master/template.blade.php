...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            {{-- ucapan berjalan untuk kasir --}}
            <marquee behavior="scroll" direction="left" class="nav-link">
                @php
                    $currentTime = now()->format('H');
                    if ($currentTime >= 9 && $currentTime < 12) {
                        echo 'Selamat Pagi, ' . Auth()->user()->name . '. Pesanan makanan dan minuman siap diterima. Semangat untuk memulai hari dengan penuh energi dan senyum!';
                    } elseif ($currentTime >= 12 && $currentTime < 18) {
                        echo 'Selamat Siang, ' . Auth()->user()->name . '. Pesanan makanan dan minuman siap diterima. Jangan lupa untuk istirahat sejenak dan nikmati hidangan lezat di tengah hari ini.';
                    } elseif ($currentTime >= 18 && $currentTime < 21) {
                        echo 'Selamat Sore, ' . Auth()->user()->name . ' Pesanan makanan dan minuman siap diterima. Semoga setelah hari yang sibuk, Anda dapat menikmati momen santai dan lezat di restoran kami.';
