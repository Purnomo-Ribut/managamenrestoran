                ...
                <div class="card">
                    ...
                    <div class="card-body tab-content">
                        <div class="tab-pane active" id="profile">
                            ...
                            <form action="{{ route('profil.update3', ['id' => Auth::user()->id]) }}" method="post">
                                {{-- alert sukses --}}
                                @if (session('success'))
                        ...
                        <div class="tab-pane" id="account">
                            ...
                            <hr>
                            <form action="{{ route('user.update3', ['id' => Auth::user()->id]) }}" method="post">
                                {{-- alert sukses --}}
                                @if (session('berhasil'))
                                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                                        {{ session('berhasil') }}
                        ...
                        <div class="tab-pane" id="security">
                            ...
                            <hr>
                            <form method="post" action="{{ route('pass.update3', ['id' => Auth::user()->id]) }}">
                                @csrf
                                @if (session('benar'))
                                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                                        {{ session('benar') }}
