...
<body>
    <div class="container">
        <div class="container rounded-1 hasil bg-light">
          ...
          <div class="content d-flex justify-content-center text-center">
            <p class="m-0">Pembayaran anda adalah Rp.200.000</p>
          </div>
          <div class="content d-flex justify-content-center text-center">
            <p class="m-1">Silahkan tunjukan ID pelanggan ke kasir!</p>
          </div>
        </div>
        <div class="kotak-putih d-flex align-items-center rounded-2">
          <p class="m-0 p-1">ID Pelanggan = 2133</p>
        </div>
      </div>
